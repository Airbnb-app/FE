      ...
      <div className="w-full flex flex-col px-5">
        ...
        <div className="form-control w-full sticky top-2 z-20  ">
          <div className="input-group  w-full">
            <input onChange={(e) => setSearch(e.target.value)} onSubmit={() => submitSearch()} type="text" placeholder="Search…" className="input input-bordered text-pink-airbnb w-full bg-white border-2 border-pink-airbnb" />
