...
function Payment() {
  ...
  const confirmHandler = (e) => {
    ...
    axios
      .post(
        `https://numpangtidur.my.id/reservations`,
        {
        ...
        <form class="w-[90%] " onSubmit={(e) => confirmHandler(e)}>
          ...
          <div class="flex flex-wrap -mx-3 mb-5">
            <div class="w-full px-3">
              <input
                class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white focus:border-pink-airbnb"
                id="grid-password"
                type="text"
          ...
          <div class="flex flex-wrap -mx-3 mb-5">
            <div class="w-full md:w-2/3 px-3 mb-6 md:mb-0">
              <input
                class="appearance-none block w-full bg-gray-200 text-gray-700 border  py-3 px-4 mb-3 leading-tight rounded focus:outline-none focus:bg-white focus:border-pink-airbnb"
                id="grid-first-name"
                type="text"
            ...
            <div class="w-full md:w-1/3 px-3">
              <input
                class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-pink-airbnb"
                id="grid-last-name"
                type="text"
                placeholder="CVV"
                onChange={(e) => {
            ...
            <div className="grid grid-col w-[90%] pt-5">
              ...
              <div className="flex justify-between pt-3">
                ...
                <div className="text-xl font-semibold">
                  <p>
                    {router?.query?.duration} nights @ {router?.query?.price_per_night}/night
                  </p>
                  <p className="text-end">Total ${router?.query?.total_price}</p>
                </div>
              </div>
              <div className="flex justify-end pt-5">
                <button className="btn h-12 border-none bg-[#FF5A60] w-20 text-white" type="submit">
                  Confirm
                </button>
              </div>
            </div>
